...
const TASK_DEFINITIONS = [
  ...
  },
  {
    ...
    relay_worker_id: null,
    notes: 'Markit HTTP announcements + CDN PDFs by default. Set ASX_FILINGS_BROWSER=1 for legacy Playwright path (DC proxies usually cannot reach asx.com.au).',
  },
  {
    slug: 'asx_manual',
    ...
    preferred_relay_tier: null,
    relay_worker_id: null,
    notes: 'Admin Run Scraper for ASX tickers (Markit HTTP).',
  },
  {
    slug: 'cse_seed',
  ...
  },
  {
    ...
    preferred_relay_tier: null,
    relay_worker_id: null,
    notes: 'ASX company directory CSV via Markit HTTP (browser fallback available).',
  },
  {
  ...
  },
  {
    ...
    preferred_relay_tier: null,
    relay_worker_id: null,
    notes: 'ASX-only pipeline — Markit HTTP filings (no Relay DC).',
  },
  {
