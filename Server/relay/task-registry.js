...
const TASK_DEFINITIONS = [
  {
    ...
    category: 'filings',
    script_entry: 'Server/Scraper/index.js',
  ...
  },
  {
    ...
    category: 'enrichment',
    script_entry: 'Server/Scraper/transfer-agents.js',
    exchange: 'TSX,TSXV',
    needs_browser: true,
    needs_captcha: true,
    captcha_site: 'sedarplus.ca',
  ...
  },
  {
    ...
    category: 'filings',
    script_entry: 'Server/Scraper/asx-filings.js',
    exchange: 'ASX',
    needs_browser: true,
    needs_captcha: false,
    captcha_site: null,
  ...
  },
  {
    ...
    category: 'seed',
    script_entry: 'Server/Scraper/cse-seed.js',
    exchange: 'CSE',
    needs_browser: true,
    needs_captcha: false,
    captcha_site: null,
  ...
  },
  {
    ...
    category: 'seed',
    script_entry: 'Server/Scraper/asx-seed.js',
    exchange: 'ASX',
    needs_browser: true,
    needs_captcha: false,
    captcha_site: null,
  ...
  },
  {
    ...
    category: 'enrichment',
    script_entry: 'Server/Scraper/analyze-one.js',
    exchange: 'ALL',
    needs_browser: false,
    needs_captcha: false,
    captcha_site: null,
