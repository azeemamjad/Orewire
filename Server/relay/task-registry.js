...
const TASK_DEFINITIONS = [
  ...
  },
  {
    ...
    category: 'enrichment',
    script_entry: 'Scraper/transfer-agents.js',
    exchange: 'TSX,TSXV',
    needs_browser: true,
    needs_captcha: true,
    captcha_site: 'sedarplus.ca',
  ...
  },
  {
    ...
    category: 'enrichment',
    script_entry: 'Server/scripts/scrape-transfer-agents.js',
    exchange: 'TSX,TSXV',
    needs_browser: true,
    needs_captcha: true,
    captcha_site: 'sedarplus.ca',
    preferred_relay_tier: 'res',
    relay_worker_id: null,
    notes: 'Admin pipeline job — spawns transfer-agents.js per batch; same captcha rules as SEDAR filings.',
  },
  {
    slug: 'sedar_manual',
  ...
  },
  {
    ...
    category: 'filings',
    script_entry: 'Scraper/asx-filings.js',
    exchange: 'ASX',
    needs_browser: true,
    needs_captcha: false,
    captcha_site: null,
  ...
  },
  {
    ...
    category: 'seed',
    script_entry: 'Scraper/cse-seed.js',
    exchange: 'CSE',
    needs_browser: true,
    needs_captcha: false,
    captcha_site: null,
  ...
  },
  {
    ...
    category: 'seed',
    script_entry: 'Scraper/asx-seed.js',
    exchange: 'ASX',
    needs_browser: true,
    needs_captcha: false,
    captcha_site: null,
  ...
  },
  {
    ...
    category: 'enrichment',
    script_entry: 'Server/scripts/scrape-profiles.js',
    exchange: 'ALL',
    needs_browser: false,
    needs_captcha: false,
    captcha_site: null,
  ...
  },
  {
    ...
    category: 'enrichment',
    script_entry: 'Scraper/analyze-one.js',
    exchange: 'ALL',
    needs_browser: false,
    needs_captcha: false,
    captcha_site: null,
